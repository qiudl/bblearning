...
final class LogoutUseCase {
    ...
    private func clearLocalSession(clearData: Bool) {
        ...
        if clearData {
            ...
            // 清除Realm数据库
            do {
                try realmManager.clearDatabase()
            ...
            let enableNotifications = UserDefaultsManager.shared.enableNotifications
            ...
            UserDefaultsManager.shared.enableNotifications = enableNotifications
        }
